document.addEventListener('DOMContentLoaded', function() {
    ...
    const details = document.querySelectorAll('details'); // Mengambil semua elemen details
    ...
    // Mencegah elemen details menutup ketika summary diklik
    details.forEach(detail => {
      detail.addEventListener('click', function(event) {
        event.stopPropagation(); // Menghentikan event agar tidak menutup
      });
    });

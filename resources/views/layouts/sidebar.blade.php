  ...
  <div class="w-full pb-20 flex flex-col gap-3 mt-5">
    ...
    <ul>
        ...
        <details {{ request()->routeIs('data_compare.transaction_detail.*') ? "open" : ""}}>
            <summary class="mb-3 hover:bg-yellow-400 p-1 pr-2 flex items-center justify-between text-base font-medium rounded-lg {{ request()->routeIs('data_compare.*') ? "bg-yellow-400" : "" }}">
            ...
            <ul id="submenu" class="ml-5 border-l-[1.5px] border-slate-200 mt-3 space-y-2">
                ...
                {{-- <li>
                    <a href="#" class="text-base font-normal pl-5 border-l-[1.5px] -ml-[1.5px] text-gray-400 hover:text-blue-950 hover:border-blue-950">{{ __("Digital Receipt") }}</a>
                </li> --}}
            </ul>
        </details>
    </ul>

<div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
    ...
    <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
        <button onclick="Swal.clickConfirm()" type="button" class="inline-flex w-full justify-center rounded-lg bg-red-500 px-3 py-2 text-sm font-semibold  text-white shadow-xs sm:ml-3 sm:w-auto">
            {{ __($actionText) }}
        </button>

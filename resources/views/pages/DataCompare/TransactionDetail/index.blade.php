<x-app-layout>
    <x-slot name="header">
        {{ __("Data Compare Transaction Detail") }}
    </x-slot>
    ...
    <form class="bg-white rounded-lg shadow-md flex flex-col items-end gap-5 p-5" onsubmit="handleSubmit(event)">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-5 gap-5 place-content-between w-full">
            ...
            <div class="col-span-2 lg:col-span-1">
                <label class="mb-2 block font-medium text-sm text-gray-950" for="selisih">{{ __("Selisih") }}</label>
                <select name="selisih" id="selisih" class="px-3 py-2 border border-gray-300 rounded-lg text-gray-300 w-full focus:ring-2 focus:ring-blue-950 focus:text-blue-950 h-10">
